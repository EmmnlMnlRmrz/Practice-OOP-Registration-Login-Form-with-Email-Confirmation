<div class="content--section">
                ...
                <div class="group">
                    ...
                    <input type="password" name="currentPassword" id="cpassword" class="<?php if($validations->errors['currentPassword']): echo 'borderRed'; endif; ?> control" placeholder="Current Password"
                ...
                <div class="group">
                    ...
                    <input type="password" name="newPassword" id="npassword" class="<?php if($validations->errors['newPassword']): echo 'borderRed'; endif; ?> control" placeholder="New Password" 
                ...
                <div class="group">
                    ...
                    <input type="password" name="confirmPassword" id="npassword" class="<?php if($validations->errors['confirmPassword']): echo 'borderRed'; endif; ?> control" placeholder="Confirm Password"
                    value="<?php if($validations->setValue('newPassword')): echo $validations->setValue('newPassword'); endif; ?>">
                    <div class="error">
                ...
                <div class="group">
                    <input type="submit" name="updatePasswordBtn" id="" class="btn btn-sweet" value="Update Password">
                </div>
                <!-- Close group -->
