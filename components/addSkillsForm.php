 <div class="content--section">
                ...
                <div class="group">
                    ...
                    <input type="text" name="skills" id="skills" class="<?php if($validations->errors['skills']): echo 'borderRed'; endif; ?> control" 
                ...
                <div class="group">
                    <input type="submit" name="skillsBtn" id="" class="btn btn-sweet" value="Save Skills">
                </div>
                <!-- Close group -->
                </form>
            </div>
